...
variable "url_map" {
  ...
  default = {
    ...
    "latest.af-south-1.hvm-ebs"     = "ami-0d3a6166c1ea4d7b4"
    "latest.ap-east-1.hvm-ebs"      = "ami-06445325c360470d8"
    "latest.ap-northeast-1.hvm-ebs" = "ami-009c422293bcf3721"
    "latest.ap-northeast-2.hvm-ebs" = "ami-0bfc0397525a67ed8"
    "latest.ap-northeast-3.hvm-ebs" = "ami-0a1fb4d4e08a6065e"
    "latest.ap-south-1.hvm-ebs"     = "ami-07ad258dcc69239d2"
    "latest.ap-southeast-1.hvm-ebs" = "ami-0f59f7f33cba8b1a4"
    "latest.ap-southeast-2.hvm-ebs" = "ami-0d1e49fe30aec165d"
    "latest.ap-southeast-3.hvm-ebs" = "ami-0f5cb24a1e3fc62dd"
    "latest.ca-central-1.hvm-ebs"   = "ami-0551a595ba7916462"
    "latest.eu-central-1.hvm-ebs"   = "ami-0702eee2e75d541d1"
    "latest.eu-north-1.hvm-ebs"     = "ami-0fc6838942cb7d9cb"
    "latest.eu-south-1.hvm-ebs"     = "ami-0df9463b8965cdb80"
    "latest.eu-west-1.hvm-ebs"      = "ami-00badba5cfa0a0c0d"
    "latest.eu-west-2.hvm-ebs"      = "ami-08f3c1eb533a42ac1"
    "latest.eu-west-3.hvm-ebs"      = "ami-04b50c79dc4009c97"
    "latest.me-south-1.hvm-ebs"     = "ami-05c52087afab7024d"
    "latest.sa-east-1.hvm-ebs"      = "ami-0732aa0f0c28f281b"
    "latest.us-east-1.hvm-ebs"      = "ami-0223db08811f6fb2d"
    "latest.us-east-2.hvm-ebs"      = "ami-0a743534fa3e51b41"
    "latest.us-west-1.hvm-ebs"      = "ami-0d72ab697beab5ea5"
    "latest.us-west-2.hvm-ebs"      = "ami-034946f0c47088751"
  }
