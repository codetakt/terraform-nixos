# DON'T EDIT, run '/home/claude/Codex/github.com/codetakt/terraform-nixos/aws_image_nixos/./update-url-map' instead
variable "url_map" {
  type = map(string)
  ...
  default = {
    ...
    "latest.af-south-1.hvm-ebs"     = "ami-0df2f7b42bfbd53e5"
    "latest.ap-east-1.hvm-ebs"      = "ami-07ba84d7321f6f4bb"
    "latest.ap-northeast-1.hvm-ebs" = "ami-0e37827874573dbbf"
    "latest.ap-northeast-2.hvm-ebs" = "ami-0ff5b3b7738651895"
    "latest.ap-northeast-3.hvm-ebs" = "ami-0a7861571eb44c70c"
    "latest.ap-south-1.hvm-ebs"     = "ami-05c4802ca81d7c95b"
    "latest.ap-southeast-1.hvm-ebs" = "ami-0aee8193da16bd2db"
    "latest.ap-southeast-2.hvm-ebs" = "ami-008be032289f60d16"
    "latest.ap-southeast-3.hvm-ebs" = "ami-033debde7c1659c96"
    "latest.ca-central-1.hvm-ebs"   = "ami-031821b5f83896474"
    "latest.eu-central-1.hvm-ebs"   = "ami-0d6ee9d5e1c985df6"
    "latest.eu-north-1.hvm-ebs"     = "ami-0cecb1f67b2a837f6"
    "latest.eu-south-1.hvm-ebs"     = "ami-0f9fee15eb5a64ac4"
    "latest.eu-west-1.hvm-ebs"      = "ami-0fc7825fe890f87d1"
    "latest.eu-west-2.hvm-ebs"      = "ami-0e62fef78d2c4f031"
    "latest.eu-west-3.hvm-ebs"      = "ami-01a6e4c1659b08390"
    "latest.me-south-1.hvm-ebs"     = "ami-0a01a7eeffa8f0fd5"
    "latest.sa-east-1.hvm-ebs"      = "ami-09a1760227f929ccf"
    "latest.us-east-1.hvm-ebs"      = "ami-07df5833f04703a2a"
    "latest.us-east-2.hvm-ebs"      = "ami-04dd2f100d9665df5"
    "latest.us-west-1.hvm-ebs"      = "ami-0fe502361fea4216c"
    "latest.us-west-2.hvm-ebs"      = "ami-0749963dd978a57c7"
  }
